...
<a name="configure-the-aws-cli"></a>
...
<a name="create-the-eks-cluster"></a>
...
```
<a name="install-and-configure-helm"></a>
...
```
<a name="install-the-strimzi-kafka-operator"></a>
...
```
<a name="deploying-the-kafka-cluster"></a>
...
```
<a name="test-the-kafka-cluster-with-nodejs-clients"></a>
