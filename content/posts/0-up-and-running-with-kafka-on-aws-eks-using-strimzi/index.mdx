...
### Contents
1. <a href="#configure-the-aws-cli">Configure the AWS CLI</a>
2. <a href="#create-the-eks-cluster">Create the EKS cluster</a>
3. <a href="#enter-k8s">Enter Kubernetes</a>
4. <a href="#install-and-configure-helm">Install and configure Helm</a>
5. <a href="#install-strimzi-kafka-operator">Install the Strimzi Kafka Operator</a>
6. <a href="#deploy-kaka-cluster">Deploying the Kafka cluster</a>
7. <a href="#analysis">Analysis</a>
8. <a href="#test-kafka-cluster">Test the Kafka cluster with Node.js clients</a>
9. <a href="#clean-up">Clean up!</a>

Let's get right into it, then!

We will be using [`eksctl`][1], the official CLI for Amazon EKS, to spin up our K8s cluster.

### Configure the AWS CLI <a name="configure-the-aws-cli"></a>
...
### Create the EKS cluster <a name="create-the-eks-cluster"></a>
...
EKS:
![AWS EKS UI](./1_xamksw0rnxsxjohb8zkh.png)

CloudFormation UI:
![Cloudformation UI](./2_8gj6kw97f6bxkm6u9a44.png)
...
### Enter Kubernetes <a name="enter-k8s"></a>
...
#### Install and configure Helm <a name="install-and-configure-helm"></a>
...
### Install the Strimzi Kafka Operator <a name="install-strimzi-kafka-operator"></a>
...
### Deploying the Kafka cluster <a name="deploy-kaka-cluster"></a>
...
![EBS UI](./3_zys2wmubcb42glzzp23m.png)
...
### Test the Kafka cluster with Node.js clients <a name="test-kafka-cluster"></a>
...
![Producer and Consumer Visualisation](./posts/0/4_a3b19iryt7pxff3z8ust.gif)
